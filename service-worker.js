...
.entryPanel--doors .entryDoor{position:relative!important;display:grid!important;place-items:stretch!important;min-width:0!important;height:100%!important;padding:10px clamp(10px,3vw,18px) calc(9px + env(safe-area-inset-bottom))!important;box-sizing:border-box!important;will-change:transform!important;transform:translateX(0)!important;background:radial-gradient(circle at 22px 22px,#c8b06e 0 4px,#2a2418 5px 9px,transparent 10px),repeating-linear-gradient(90deg,rgba(255,255,255,.05) 0 1px,transparent 1px 9px),linear-gradient(180deg,#6c6144 0%,#27251c 22%,#11150e 58%,#5a5138 100%)!important;border:1px solid rgba(154,131,82,.74)!important;box-shadow:inset 0 0 0 2px rgba(0,0,0,.62),inset 0 12px 22px rgba(0,0,0,.55),0 -10px 30px rgba(0,0,0,.72)!important;z-index:1!important;}
