(function(){
  const FRAME_STYLESHEET='css/frame-system-v2.css?v=ast049';
  const RELEASE_STYLESHEET='css/ast-012-4.css?v=ast049';
  const HEADER_STYLESHEET='css/ast-013-2.css?v=ast049';
