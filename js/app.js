...
if(window.GoogleAuthService){GoogleAuthService.init().then(renderGoogleAuthStatus);googleAuthButton.onclick=async()=>{if(GoogleAuthService.isSignedIn())GoogleAuthService.signOut();else await GoogleAuthService.signIn();renderGoogleAuthStatus()}}
